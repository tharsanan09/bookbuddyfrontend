...
import { FaBook, FaUser, FaTruck, FaExclamationCircle } from 'react-icons/fa';
  ...
  import publishManagement from './Managements/PublishManagement';
  ...
  return (
    <div className="container" style={{backgroundcolor: '#e6cab3'}}>
      ...
      <div className="d-flex gap-3 mt-5 mb-4">
        ...
        <button onClick={() => navigate('/admin/publishmanagement')} className="btn mt-3 btn-purple px-3 rounded-pill">Publish Management</button>
